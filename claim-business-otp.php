...
session_start();
include('db_conn.php');
if(!isset($_POST['submit_claim_business']))
{
     header("location:claim-business.php?id=".$_SESSION['claim_id']);
}

if (isset($_POST["submit_claim_business_otp"])){
}
else{
		$otp=$_SESSION['claim_otp'];
		$query = "SELECT * FROM seller_login WHERE id = ".$_SESSION['claim_id'];	
	...
	<section class="tz-register">
			<div class="log-in-pop">
				...
				<div class="log-in-pop-right">
					...
					<form class="s12" method="POST" action="claim-business-set-email.php">
						<div>
						...
						<div>
							<div class="input-field s4">
								<input type="submit" name="submit_claim_business_otp" value="Verify" class="waves-effect waves-light log-in-btn"> </div>
						</div>
						<div>
							<div class="input-field s12"><a href="claim-business.php">Back</a> </div>
						</div>
					</form>
				</div>
			</div>
