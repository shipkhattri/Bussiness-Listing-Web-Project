<?php
session_start();
$_SESSION['claim_otp']=rand(100000,999999);
if(!isset($_GET['id']))
{
     header("location:index.php");
}
else{
    $_SESSION['claim_id']=$_GET['id'];
}
	...
	<section class="tz-register">
			<div class="log-in-pop">
				...
				<div class="log-in-pop-right">
					...
					<p></p>
					<form class="s12" action="claim-business-otp.php" method="POST">
						<div>
							<div class="input-field s12">
								<input type="text" data-ng-model="name1" name="mobile" class="validate" required>
								<label>Mobile No</label>
							</div>
						</div>
						<div>
							<div class="input-field s4">
								<input type="submit" name="submit_claim_business" value="Get OTP" class="waves-effect waves-light log-in-btn"> </div>
						</div>
						<div>
