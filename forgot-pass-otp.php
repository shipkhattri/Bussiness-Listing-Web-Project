...
{
    	$query = "SELECT * FROM seller_login WHERE username = '".$_POST['username']."'";	
	...
	<section class="tz-register">
			<div class="log-in-pop">
				...
				<div class="log-in-pop-right">
					...
					<form class="s12" method="POST" action="change-pass.php">
						<div>
						...
						<div>
							<div class="input-field s4">
								<input type="submit" name="submit_forgot_pass_otp" value="Verify" class="waves-effect waves-light log-in-btn"> </div>
						</div>
						<div>
							<div class="input-field s12"><a href="forgot-pass.php">Back</a> </div>
						</div>
					</form>
				</div>
			</div>
