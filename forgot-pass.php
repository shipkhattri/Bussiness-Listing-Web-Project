<?php
session_start();
$_SESSION['both_otp']=rand(100000,999999);
?>
	...
	<section class="tz-register">
			<div class="log-in-pop">
				...
				<div class="log-in-pop-right">
					...
					<p></p>
					<form class="s12" action="forgot-pass-otp.php" method="POST">
						<div>
							<div class="input-field s12">
								<input type="text" data-ng-model="name1" name="username" class="validate" required>
								<label>User name</label>
							</div>
						</div>
						<div>
							<div class="input-field s4">
								<input type="submit" name="submit_forgot_pass" value="Get OTP" class="waves-effect waves-light log-in-btn"> </div>
						</div>
						<div>
