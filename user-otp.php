...
{
		if( $_SESSION['user_both_otp'] == $_POST["otp"])
		{
			$sql = "UPDATE `user_login` SET `verified` = '1' WHERE `username` = '".$_SESSION['new_username']."'";	
...
{
    	$query = "SELECT * FROM user_login WHERE username = '".$_SESSION['new_username']."'";	
				...
				<div class="log-in-pop-right">
					...
					<form class="s12" method="POST" action="">
						...
						<div>
							...
							<div>
							<div class="input-field s12"> <a href="user-otp.php">Resend OTP</a> </div>
						</div>
					</form>
				</div>
			</div>
